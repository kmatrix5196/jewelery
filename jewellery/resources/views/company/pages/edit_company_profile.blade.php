                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="login-reg-form-wrap sign-up-form">
                            <h5 class="Royal_Crescent_Bold">Edit Profile</h5>
                            <br>
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                      <div class="single-input-item">
                                          <p class="form-help-text mt-0">Name</p>
                                          <input class="form-control" type="text" placeholder="{{$company->name}}" name="name" value="{{$company->name}}" required autocomplete="off">
                                      </div>
                                  </div>
                                  <div class="col-lg-6">
                                      <div class="single-input-item">
                                          <p class="form-help-text mt-0">Business Type</p>
                                          <input class="form-control" type="text" placeholder="{{$company->business_type}}" name="business_type" value="{{$company->business_type}}" required autocomplete="off">
                                      </div>
                                  </div>
                              </div>
                              <br>
                    ...
                    <div class="product-upload-gallery row flex-wrap">
                        <div class="col-12 mb-30">
                            ...
                            <input class="file-pond" type="file" multiple name="b_img2" accept="image/*">
                                ...
                                <div class="single-input-item">
                                    <p class="form-help-text mt-0">Main Product</p>
                                    <input class="form-control" type="text" placeholder="{{$company->main_product}}" name="main_product" value="{{$company->main_product}}" required autocomplete="off">
                                </div>
                                <div class="single-input-item">
                                    <p class="form-help-text mt-0">Year Established</p>
                                    <input class="form-control" type="date" placeholder="{{$company->year_established}}" name="year_established" value="{{$company->year_established}}" required autocomplete="off" />
                                </div>
                                <div class="single-input-item">
                                    <p class="form-help-text mt-0">Tel :</p>
                                    <input class="form-control" type="tel" placeholder="{{$company->phone}}" name="tel" value="{{$company->phone}}" required autocomplete="off"/>
                                </div>
                                <div class="single-input-item">
                                    <p class="form-help-text mt-0">Email :</p>
                                    <input class="form-control" type="email" placeholder="{{$company->email}}" name="email" value="{{$company->email}}" required autocomplete="off"/>
                                </div>
                                <div class="single-input-item">
                                    <p class="form-help-text mt-0">Address :</p>
                                    <input class="form-control" type="text" placeholder="{{$company->location}}" name="location" value="{{$company->location}}" required autocomplete="off"/>
                                </div>
                                <div class="single-input-item">
                                ...
                                <div class="single-input-item">
                                    <button class="btn btn-sqr" value="{{$company->id}}" name="id" type="submit">Save Profile</button>
                                </div>
                            </form>
                        </div>
                    </div>
