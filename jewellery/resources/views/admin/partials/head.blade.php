    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('administrator/img/favicon.ico')}}">
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('administrator/css/vendor/bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('administrator/css/preloader.css')}}">
