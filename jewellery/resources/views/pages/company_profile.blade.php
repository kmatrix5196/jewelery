                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-thumb"><br><br><br>
                                <img src="https://images.unsplash.com/photo-1484861671664-4ebd42ced711?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="about thumb">
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="about-content">
                                <h3 class="about-title bowly-font" style="color:#c29958;">Company Profile</h3>
                                <button class="btn btn-zg2">Chat Now</button>
                                <br><br><br>


                                <p>For those that rather the full immersion of the in store experience we welcome your company and look forward to meeting you face to face. Being located in the 47 street diamond district, known to be the largest diamond.
                                Based in the heart of New York’s Diamond District, also known as the NYC diamond district, I. D. Jewelry has some of the most competitively priced in the market. It is our goal to supply our clients.</p>
                            </div>
                        </div>
                    </div><br><br>
                                    ...
                                    <table class="table table-bordered mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="pro-stock">
                                                  Western Europe 15.00%<br>
                                                  North America 15.00%<br>
                                                  Mid East 12.00%
                                                </td>
                    ...
                    <div class="col-lg-12">
                        <div class="shop-product-wrapper">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.php">Platinum</a></p>
                                            </div>

                                            <h6 class="product-name">
                                                <a href="product-details.php">Jewellery Title</a>
                                            </h6>
                                            <div class="price-box">
                                    ...
                                    <div class="product-list-item">
                                        <figure class="product-thumb">
                                            ...
                                            <div class="button-group">
                                                ...
                                                <a href="compare.php" data-toggle="tooltip" data-placement="left" title="Add to Compare"><i class="pe-7s-refresh-2"></i></a>
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.php">Platinum</a>
                                            </div>
                                            ...
                                            <h5 class="product-name"><a href="product-details.php">Jewellery Title</a></h5>
                                            <div class="price-box">
                            ...
                            <div class="row justify-content-center">                                                          
                                <a href="supplier_company.php"><button class="btn btn-hero">See More</button></a>                                            
                            </div>
                        </div>
                    </div>
