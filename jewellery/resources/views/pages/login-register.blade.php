                    ...
                    <div class="col-12">
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="30" height="30"
                                    viewBox="0 0 172 172"
                            ...
                            <div class="login-reg-form-wrap sign-up-form">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="col-lg-8">
                                      <div class="single-input-item">
                                        ...
                                        <div class="custom-control custom-radio" style="margin-bottom:7px;">
                                          ...
                                          <label class="custom-control-label" for="flatrate">Suppliers</label>
                                        </div>
                                        <div class="custom-control custom-radio" style="margin-bottom:7px;">
                                            <input type="radio" id="freeshipping" name="shipping" class="custom-control-input" />
                                            <label class="custom-control-label" for="freeshipping">Buyers</label>
                                        </div>
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="single-input-item">
                                              <input type="password" placeholder="First Name" required />
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="single-input-item">
                                    ...
                                    <div class="single-input-item">
                                        <input type="email" placeholder="Tel :" required />
                                    </div>
                                    <div class="single-input-item">
