...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="assets/fonts/royal_crescent_light-webfont.svg">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery.rateit/1.1.2/rateit.min.css.map">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery.rateit/1.1.2/star.gif">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery.rateit/1.1.2/delete.gif">
        ...
        <section class="slider-area">
            <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                ...
                <div class="hero-single-slide hero-overlay">
                    <div class="hero-slider-item bg-img" data-bg="assets/img/sample/slider-sample.jpg">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                ...
                <div class="row row-20 mtn-20">
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="shop.php">
                                <img src="assets/img/sample/banner-top.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-lg-6">
                        <div class="group-product-banner">
                            <figure class="banner-statistics">
                                <a href="shop.php">
                                    <img src="assets/img/sample/img-bottom-banner.jpg" alt="product banner">
                                </a>
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="product-details.php">
                                                    <img src="assets/img/sample/product-sample.jpg" alt="">
                                                </a>
                                            </div>
